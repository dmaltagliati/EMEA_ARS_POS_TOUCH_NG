...
public class GdPos extends Border implements Graphical, ActionListener, AdjustmentListener, MouseWheelListener {
    ...
    public void init(Dimension d) {
        ...
        dspArea[0] = new GdLabel("enabling peripheral6", GdLabel.STYLE_HEADER);
        ...
        File f = Config.localFile("ts1024", "GROUND.GIF");
    ...
    public static void main(String[] args) {
        ...
        UnDeco.show(panel, 1024, 768);
        Config.logConsole(1, null, "client " + d.width + "x" + d.height);
        // System.getProperties ().list (System.out);
        Config.logConsole(1, "--- VERSION --- ", PosVersion.fullVersion());
        ComponentVersion.writeComponentVersion("Pos Application", PosVersion.getDate(), PosVersion.shortVersion() + " ts1024");
    }
