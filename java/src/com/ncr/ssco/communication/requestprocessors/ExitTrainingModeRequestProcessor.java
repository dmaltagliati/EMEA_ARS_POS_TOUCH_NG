...
public class ExitTrainingModeRequestProcessor extends DefaultRequestProcessor {
    private static final Logger logger = Logger.getLogger(ExitTrainingModeRequestProcessor.class);

    public ExitTrainingModeRequestProcessor(SscoMessageHandler messageHandler) {
    ...
    public void sendResponses(SscoError sscoError) {
        ...
        ResponseToSsco responseToSsco = getMessageHandler().createResponseToSsco("TrainingModeExited");
